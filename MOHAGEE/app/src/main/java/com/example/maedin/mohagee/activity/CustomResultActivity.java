...
public class CustomResultActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd = findViewById(R.id.btn_custom_add);
        ...
        try {
            ...
            for(int  i  = 0 ; i<jsonArray.length()-1 ; i++)
            {
                ...
                locIds+=jsonArray.getJSONObject(i).getString("loc_id");
                locIds+="@";
            }
    ...
    public void addPath()
    {
        final LinearLayout layout = (LinearLayout) View.inflate(this,R.layout.dialog_custom_add, null);
        AlertDialog.Builder dlg = new AlertDialog.Builder(this);
        dlg.setTitle("커스텀 경로 추가");
        ...
        dlg.setPositiveButton("확인", new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                EditText name = layout.findViewById(R.id.edit_custom_name);

                Message msg = new Message();
                msg.what = 12;
                serverThread.setAddCustomPath(((App)getApplication()).getUser().getId(), locIds, name.getText().toString(), myResult);
   ...
   /* @Override
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if(msg.what == 12)
            {
                Log.d("ADD", msg.obj.toString());
                Toast.makeText(CustomResultActivity.this, "내 경로에 추가되었습니다!",Toast.LENGTH_SHORT).show();
            }
